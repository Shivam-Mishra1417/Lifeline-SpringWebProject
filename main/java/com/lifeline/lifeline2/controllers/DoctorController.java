...
public class DoctorController {
	...
	public ResponseEntity<JSONArray> getSelfAssessmentScores(Model model) throws Exception {
		...
		String query = "SELECT patient.first_name, patient.last_name, patient.email,\n" +
				...
				"ON patient.email=self_assessment.email "
				+ "where self_assessment.appointment_status = \"Pending\"  and not exists (select * from appointment where patient_id = patient.email and status != \"CANCEL\");";
...
@GetMapping("/getFutureAppointments/{doctor_email}")  //API #4
	...
	public ResponseEntity<JSONArray> dailyPatientCount(Model model) throws Exception {
		...
		String user = "root";
		String password = "root123";
		String query = "select DATE(created_date) as DAY, count(email) as COUNT from patient group by DATE(created_date);";
	...
	public ResponseEntity<JSONArray> monthlyPatientCount(Model model) throws Exception {
		...
		String user = "root";
		String password = "root123";
		String query = "select MONTH(created_date) as MONTH ,YEAR(created_date) as YEAR , count(email) as COUNT\n" +
				"from patient group by MONTH(created_date), YEAR(created_date);";
	...
	public ResponseEntity<JSONArray> weeklyPatientCount(Model model) throws Exception {
		...
		String user = "root";
		String password = "root123";
		String query = "select WEEK(created_date) as WEEK,MONTH(created_date) as MONTH,YEAR(created_date) as YEAR, count(email) as COUNT from patient group by WEEK(created_date),MONTH(created_date), YEAR(created_date);";
